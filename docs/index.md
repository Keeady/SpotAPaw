...
📧 **Email**: [spotapaw@spotapaw.com](mailto:spotapaw@spotapaw.com)

### Data or Account Deletion

To request deletion of your data or account, send an email from the address associated with your account to [spotapaw@spotapaw.com](mailto:spotapaw@spotapaw.com) with the subject **DATA DELETION REQUEST**.
