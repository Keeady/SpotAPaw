...
export default function PublicHome() {
  ...
  return (
    ...
    <Head>
      ...
      <meta name="description" content="SpotAPaw is a community-powered app that uses AI to automatically generate detailed pet descriptions from photos, so you can post a detailed lost or found pet report quickly." />
